...
let guestList:string[] = ["Zakia","Rukaiya" , "Shehnaz"];
guestList.forEach(Element =>{
    console.log(`I would cordially invite you to the dinner ${Element}.`)
})

//Task 15
// Question 15: Changing Guest List: One of your guests can't make it to the dinner, so you need to send out a new set of invitations with a replacement guest.

let notCome = guestList.pop()
console.log(`Dear ${notCome}, I just heared that you can't make it to the Dinner`)

guestList.push("Meherma");

guestList.forEach(Element =>{
    console.log(`Dear ${Element}, I cordially invite you to the Dinner`);
})
...
guestList.unshift("Kainat"); guestList.splice(3 , 0 , "Mehwish"); guestList.push("Sehrish");  
guestList.forEach(Element=>{
    console.log(`Dear ${Element}, I cordially invite you to the Dinner.`);
})
...
guestList.pop(); guestList.shift(); guestList.splice(3 , 1);
...
console.log(`I have invited ${guestList.length} to the Dinner`);
